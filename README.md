...
API REST para gerenciamento de tarefas desenvolvida com Node.js, TypeScript e Prisma com testes unitarios usando jest e cypress (sim, cypress para testar api).

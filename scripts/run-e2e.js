...
async function runTests() {
  ...
  function startCypress() {
    ...
    cypress.on('close', (code) => {
      ...
      // Mata o servidor
      // No Windows, matar o processo iniciado por shell pode ser chato, vamos tentar tree-kill se necessário, 
      // mas por enquanto tentar matar o processo node
